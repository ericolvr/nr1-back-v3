...
// DepartmentSnapshot representa um snapshot de departamento encerrado
type DepartmentSnapshot struct {
	SnapshotID         int64      `json:"snapshot_id"`
	TemplateID         int64      `json:"questionnaire_id"`   // Mantém nome do frontend
	TemplateName       string     `json:"questionnaire_name"` // Mantém nome do frontend
	DepartmentID       int64      `json:"department_id"`
	DepartmentName     string     `json:"department_name"`
